                ...
                <div class="row clearfix">
                    ...
                    <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <section class="services-single">
                            ...
                            <h2 class="service-title" style="margin-top:-25px;">WTT Surgery Statistics</h2>
                            <!--Default Text Block-->
                            ...
                            ?>
                                ...
                                <div style="margin-top:-10px;width:100%;height:700px">
                                    <table class="table-fill">
                                        <thead>
                                            <tr>
                                                <th class="text-left">Year <?= $wttsurgery[0]['wttyr']; ?></th>
                                        ...
                                        <tbody class="table-hover">
                                            <?php
                                            for($j=0;$j<sizeof($wttsurgery);$j++)
                                            { 
                                                ?>
                                            <tr>
                                                <td class="text-left"><?= $wttsurgery[$j]['month']; ?></td>
                                                <td class="text-left"><?= $wttsurgery[$j]['totalsurgery']; ?></td>
                                            ...
                                            <tr class="tosum">
                                                <td>Total Surgery</td>
                                                <td><?= $wttyr[$i]['totalyearsurgery']; ?></td>
                                            </tr>
