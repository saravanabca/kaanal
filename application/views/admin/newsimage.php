...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">News Image</h4>
								<p class="flex-space-1"></p>
								<a class="btn btn-primary" id="addNew">Add News Image</a>
							</div>
						</div>
					</div>
					<!-- end page title -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">News Image</h5>
                                </div>
                                <form id="formModal">
	...
	<script src="<?php echo base_url(); ?>custom/newsimage.js"></script>
