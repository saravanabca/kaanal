...
<head>
	<title>wttcenters Details</title>
...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">wttcenters Details</h4>
								<p class="flex-space-1"></p>
								<a class="btn btn-primary" id="addNew">Add wttcenters</a>
							</div>
						</div>
					</div>
					<!-- end page title -->
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-12">
										 ...
										 <div class="mb-3">
                                                <label for="example-color-input" class="form-label">Name of the Centers </label>
                                            ...
                                            <div class="mb-3">
                                                <label for="example-color-input" class="form-label">District</label>
                                                <input class="form-control" type="text" id="district" name="district" placeholder="Enter District">
                                                <h5 class="invalid-feedback district"></h5>
                                            </div>
	...
	<script src="<?php echo base_url(); ?>custom/wttcenters.js"></script>
