...
<body>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="mb-3">
                                                <label for="example-color-input" class="form-label">About Trust Description</label>
                                                <input class="form-control" type="text" id="about_description" name="about_description" placeholder="Enter Research Partner Description Description">
                                                <h5 class="invalid-feedback about_description"></h5>
                                            </div>
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">About Trust Image</label>
	...
	<script src="<?php echo base_url(); ?>custom/about/abouttrust.js"></script>
