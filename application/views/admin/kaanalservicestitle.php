...
<head>
	<title>kaanalservices title</title>
...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">kaanalservices title</h4>
								<p class="flex-space-1"></p>
								<a class="btn btn-primary" id="addNew">Add kaanalservices title </a>
							</div>
						</div>
					</div>
					<!-- end page title -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">kaanalservices title</h5>
                                </div>
                                <form id="formModal">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" id="kaanalservicestitle" name="kaanalservicestitle" placeholder="Enter kaanalservices Description">
	...
	<script src="<?php echo base_url(); ?>custom/kaanalservicestitle.js"></script>
