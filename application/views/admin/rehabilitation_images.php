...
<body>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Rehabilitation Image</label>
	...
	<script src="<?php echo base_url(); ?>custom/rehabilitation_image.js"></script>
