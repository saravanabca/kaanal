...
<head>
	<title>WTT patient statistics Details</title>
...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">WTT patient statistics </h4>
								<p class="flex-space-1"></p>
								<a class="btn btn-primary" id="addNew">Add WTT patient statistics</a>
							</div>
						</div>
					</div>
					<!-- end page title -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">WTT patient statistics</h5>
                                </div>
                                <form id="formModal">
                                    ...
                                    <div class="row">
                                        ...
                                        <label for="example-color-input" class="form-label">News Title</label>
										 ...
										 <!-- <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="example-color-input" class="form-label">Total Patients</label>
                                                <input class="form-control" type="text" id="totalpatients" name="totalpatients" placeholder="Enter Total Patients">
                                                <h5 class="invalid-feedback totalpatients"></h5>
                                            </div>
	...
	<script src="<?php echo base_url(); ?>custom/wttpatient.js"></script>
