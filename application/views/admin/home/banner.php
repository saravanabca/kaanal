...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								...
								<a class="btn btn-primary" id="addNew">Add Banner</a>
							</div>
						</div>
					</div>
					<!-- end page title -->
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-12">
											...
											<div class="mb-3">
                                                <label for="example-color-input" class="form-label">Banner Title</label>
                                                <textarea class="form-control" type="text" id="bannertitle" name="bannertitle" placeholder="Enter banner title" rows="4"></textarea>
                                                <h5 class="invalid-feedback bannertitle"></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
	...
	<script src="<?php echo base_url(); ?>custom/Home/banner.js"></script>
</body>
