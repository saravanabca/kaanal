...
<head>
	<title>Inaugration Function</title>
...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">Inaugration Function</h4>
								<p class="flex-space-1"></p>
								<a class="btn btn-primary" id="addNew">Add Inaugration Function</a>
							</div>
						</div>
					</div>
					<!-- end page title -->
								...
								<div class="card-body">
									<table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
										<thead>
											<tr>
												<th>S.No</th>
												<th>Inaugration Function Image</th>
												<th>Action</th>
											</tr>
										</thead>
										<tbody>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">Inaugration Function</h5>
                                </div>
                                <form id="formModal">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Inaugration Function Image</label>
	...
	<script src="<?php echo base_url(); ?>custom/Home/inaugrationfunction.js"></script>
</body>
