...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								...
								<!-- <a class="btn btn-primary" id="addNew">Add Profile</a> -->
							</div>
						</div>
					</div>
					<!-- end page title -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                        <div class="mb-3">
                                                <label for="example-color-input" class="form-label">Profile</label>
	...
	<script src="<?php echo base_url(); ?>custom/Home/profile.js"></script>
