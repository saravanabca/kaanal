...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">Appeal Details</h4>
								<p class="flex-space-1"></p>
								<!-- <a class="btn btn-primary" id="addNew">Add Appeal</a> -->
							</div>
						</div>
					</div>
					<!-- end page title -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">Appeal Details</h5>
                                </div>
                                <form id="formModal">
                                <div class="modal-body">
                                    <div class="row">
										...
										<div class="mb-3">
                                                <label for="example-color-input" class="form-label">Appeal Description</label>
                                                <input class="form-control" type="text" id="appeal_description" name="appeal_description" placeholder="Enter Appeal">
                                                <h5 class="invalid-feedback appeal_description"></h5>
                                            </div>
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Appeal Image</label>
	...
	<script src="<?php echo base_url(); ?>custom/appeal.js"></script>
	<script src="<?php echo base_url(); ?>assets/admin/libs/%40ckeditor/ckeditor5-build-classic/build/ckeditor.js"></script>
    <script>
        ClassicEditor.create(document.querySelector("#appeal_description")).then(function(e){e.ui.view.editable.element.style.height="200px"; appealdescription = e}).catch(function(e){console.error(e)});
    </script>
</body>
