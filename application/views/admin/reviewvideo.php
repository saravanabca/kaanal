...
<body>
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
								<h4 class="mb-sm-0 font-size-18">Review video</h4>
								<p class="flex-space-1"></p>
								<a class="btn btn-primary" id="addNew">Add Review video</a>
							</div>
						</div>
					</div>
					<!-- end page title -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">Review video</h5>
                                </div>
                                <form id="formModal">
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Review video</label>
                                                <input class="form-control" type="file" id="video_url" name="video_url">
                                                <h5 class="invalid-feedback video_url"></h5>
                                                <video width="100" height="150"  id="user_uploaded_vidio" autoplay muted>
	...
	<script src="<?php echo base_url(); ?>custom/reviewvideo.js"></script>
