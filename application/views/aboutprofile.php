    ...
    <div class="page-wrapper">
        ...
        <div class="sidebar-page-container" style="margin-top:-75px;">
            <div class="auto-container">
                ...
                <?php
                 for($i=0;$i<sizeof($aboutprofile);$i++)
                { ?>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <aside class="sidebar">
                            <div class="sidebar-title">
                                <h2><?= $aboutprofile[$i]['name']; ?></h2>
                            </div>
                            <img src="<?php echo base_url(); ?><?= $aboutprofile[$i]['image_url']; ?>" style="width:100%;">
                            <span class="about-address"><p><?= $aboutprofile[$i]['address']; ?></p></span>
                            ...
                            <iframe width="100%" height="200" src="<?= $aboutprofile[$i]['videolink']; ?>"
                    ...
                    <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                        <section class="news-section list-view blog-detail no-padd-bottom no-padd-top">
                            ...
                            <div class="news-style-one">
                                ...
                                <span class="profiledes"><?= $aboutprofile[$i]['profile_description']; ?></span>
