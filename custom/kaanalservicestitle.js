$(document).ready(function() {      
    var coreJSON,kaanalservicestitle_id ,mode;
...
// *************************** [Validation] ******************************************************************** 
    $('#formSubmit').click(function(){
        ...
        {
            $('.kaanalservicestitle').html('Please Enter Title');
    ...
    {       
        ...
        // data.append("kaanalservicestitle",kaanalservicestitle.getData());
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_kaanalservicestitle";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_kaanalservicestitle";
            data.append("kaanalservicestitle_id",kaanalservicestitle_id);
        }
        request = $.ajax({
                type: "POST",
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_kaanalservicestitle',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        // kaanalservicestitle.setData(coreJSON[r_index].kaanalservicestitle);
        $('#user_uploaded_image').attr("src", base_URL+coreJSON[r_index].image_url);
        $("#user_uploaded_image").addClass("active");
        $("#user_uploaded_image").css("display", "block");
        kaanalservicestitle_id = coreJSON[r_index].kaanalservicestitle_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_kaanalservicestitle',
                data: {"kaanalservicestitle_id":kaanalservicestitle_id },
                success: function (data) {
                    var insertResult = $.parseJSON(data);
                    if(insertResult.status=="success")
                    {
