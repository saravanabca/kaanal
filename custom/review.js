...
// *************************** [Validation] ******************************************************************** 
    $('#formSubmit').click(function(){
        ...
        {
            $('.image_url').html('Please choose Review image');
            $('.image_url').show();
        }
          else
        {
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_review";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_review";
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_review',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        $("#user_uploaded_image").css("display", "block");
        review_id = coreJSON[r_index].review_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_review',
