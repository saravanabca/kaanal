$(document).ready(function() {      
    var coreJSON,rehabilitationimage_id ,mode;
...
// *************************** [Validation] ******************************************************************** 
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_rehabilitationimage";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_rehabilitationimage";
            data.append("rehabilitationimage_id",rehabilitationimage_id);
        }
        request = $.ajax({
                type: "POST",
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_rehabilitationimage',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        $("#user_uploaded_image").css("display", "block");
        rehabilitationimage_id = coreJSON[r_index].rehabilitationimage_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_rehabilitationimage',
                data: {"rehabilitationimage_id":rehabilitationimage_id },
                success: function (data) {
                    var insertResult = $.parseJSON(data);
                    if(insertResult.status=="success")
                    {
