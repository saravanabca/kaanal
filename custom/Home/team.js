...
// *************************** [Validation] ******************************************************************** 
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_team";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_team";
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_team',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        $("#user_uploaded_image").css("display", "block");
        team_id = coreJSON[r_index].team_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_team',
