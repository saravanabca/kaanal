...
// *************************** [Validation] ******************************************************************** 
    $('#formSubmit').click(function(){
       ...
       if(aboutdescription.getData() == '')
        {
            $('.about_description').html('Please Enter The Hospital Detail Description');
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_about";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_about";
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_about',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        // $("#user_uploaded_image").css("display", "block");
        about_id = coreJSON[r_index].about_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_about',
