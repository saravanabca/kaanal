...
// *************************** [Validation] ******************************************************************** 
    $('#formSubmit').click(function(){
        ...
        if($('#video_link').val()=="" && mode == 'new')
        {
            $('.video_link').html('Please choose Video Link');
            $('.video_link').show();
        }
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_video";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_video";
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_video',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        mode = "update";
        $('#myModal').modal('show');
        $('#video_link').val(coreJSON[r_index].video_link);
       
        video_id = coreJSON[r_index].video_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_video',
