...
// *************************** [Validation] ******************************************************************** 
    $('#formSubmit').click(function(){
        $('.invalid-feedback').hide();
         if($('#event_title').val()=="" && mode == 'new')
        {
            $('.event_title').html('Please choose event Title');
            $('.event_title').show();
        }
        else if($('#image_url').val()=="" && mode == 'new')
        {
            $('.image_url').html('Please choose event image');
            $('.image_url').show();
        }
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_event";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_event";
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_event',
            type:'POST',
            success:function(data){
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_event',
