$(document).ready(function() {      
    var coreJSON,teamdetails_id ,mode;
...
// *************************** [Validation] ******************************************************************** 
    $('#formSubmit').click(function(){
        ...
        if($('#team_id').val()=="" && mode == 'new')
        {
            $('.team_id').html('Please choose Representatives Name ');
            $('.team_id').show();
        }
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_teamdetails";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_teamdetails";
            data.append("teamdetails_id",teamdetails_id);
        }
        request = $.ajax({
                type: "POST",
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_teamdetails',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        mode = "update";
        $('#myModal').modal('show');
        $('#team_id').val(coreJSON[r_index].team_id);
        ...
        // $("#user_uploaded_image").css("display", "block");
        teamdetails_id = coreJSON[r_index].teamdetails_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_teamdetails',
                data: {"teamdetails_id":teamdetails_id },
                success: function (data) {
                    var insertResult = $.parseJSON(data);
                    if(insertResult.status=="success")
                    {
