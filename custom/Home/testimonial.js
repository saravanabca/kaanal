$(document).ready(function() {      
    var coreJSON,testimonial_id ,mode;
...
// *************************** [Validation] ******************************************************************** 
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_testimonial";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_testimonial";
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_testimonial',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        $("#user_uploaded_image").css("display", "block");
        testimonial_id = coreJSON[r_index].testimonial_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_testimonial',
