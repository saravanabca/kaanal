$(document).ready(function() {      
    var coreJSON,inaugration_id ,mode;
...
// *************************** [Validation] ******************************************************************** 
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_inaugration";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_inaugration";
            data.append("inaugration_id",inaugration_id);
        }
        request = $.ajax({
                type: "POST",
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_inaugration',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        $("#user_uploaded_image").css("display", "block");
        inaugration_id = coreJSON[r_index].inaugration_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_inaugration',
                data: {"inaugration_id":inaugration_id },
                success: function (data) {
                    var insertResult = $.parseJSON(data);
                    if(insertResult.status=="success")
                    {
