...
// *************************** [Validation] ******************************************************************** 
    $('#formSubmit').click(function(){
       ...
       if(profiledescription.getData() == '')
        {
            $('.profile_description').html('Please Enter The Hospital Detail Description');
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_profile";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_profile";
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_profile',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        // $("#user_uploaded_image").css("display", "block");
        profile_id = coreJSON[r_index].profile_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_profile',
