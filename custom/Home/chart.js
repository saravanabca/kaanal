...
// *************************** [Validation] ******************************************************************** 
    ...
    {       
        ...
        if (mode == "new")
        {
            var url = base_URL+"admin/KaanalAdmin/insert_chart";
        }
        else if (mode == "update")
        {
            var url = base_URL+"admin/KaanalAdmin/update_chart";
            data.append("chart_id",chart_id);
        }
        request = $.ajax({
                type: "POST",
    ...
    {
        return $.ajax({
            url: base_URL+'admin/KaanalAdmin/get_chart',
            type:'POST',
            success:function(data){
...
// *************************** [Display] ********************************************************************
 ...
 $(document).on('change', '#image_url', function() {
    ...
    $(document).on('click', '.btnEdit', function() {
        ...
        $("#user_uploaded_image").css("display", "block");
        chart_id = coreJSON[r_index].chart_id;
    });
    ...
    $(document).on('click','.BtnDelete',function(){
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "POST",
                url: base_URL+'admin/KaanalAdmin/delete_chart',
